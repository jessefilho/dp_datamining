...
trainTree_Rock = rpart(Class ~ Rock+tempo+accoustiness+loudness+typegroup, data = train, method = "class")
...
#Model classfication of train
testTree_Rock = rpart(Class ~ Rock+tempo+accoustiness+loudness+typegroup, data = test, method = "class")
...
for(i in 1:10){
  ...
  #Model classfication of train
  trainTree_Rock = rpart(Class ~ Rock+tempo+accoustiness+loudness+typegroup, data = trainData, method = "class")
