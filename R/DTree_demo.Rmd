...
othersG$Class[othersG$genretype=='Others'] <- 0
othersG$Class[othersG$genretype=='Rock'] <- 1
othersG$Class[othersG$genretype=='Pop'] <- 2
othersG$Class[othersG$genretype=='Hip Hop'] <- 3
othersG$Class[othersG$genretype=='Jazz'] <- 4
othersG$Class[othersG$genretype=='Funk'] <- 5
othersG$Class[othersG$genretype=='Folk'] <- 6
othersG$Class[othersG$genretype=='Classical'] <- 7
othersG$Class[othersG$genretype=='Blues'] <- 8
othersG$Class[othersG$genretype=='Country'] <- 9
othersG$Class[othersG$genretype=='Electronic'] <- 10
...
test<-stratified(allGenres,"genretype", size=.5)
...
set.seed(7)
lvaFormula = genretype ~ +tempo+energy+danceability+speechiness+accoustiness+loudness+loudness+valence+instrumentalness+Class-genretype
